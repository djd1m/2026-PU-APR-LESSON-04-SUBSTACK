...
description: Intelligent feature implementation pipeline. Analyzes complexity and selects
  optimal approach (/plan, /feature), then executes autonomously
  with parallel agents and frequent commits.
...
| -1 or higher | `/feature` | Standard feature, needs SPARC lifecycle |
