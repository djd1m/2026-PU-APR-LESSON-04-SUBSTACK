...
| INS-007 | `Error creating UUID`, `invalid character`, `500 subscribe` | Subscribe endpoint receives slug but Prisma expects UUID — detect and switch | Active | 1 | [INS-007-subscribe-slug-vs-uuid.md](INS-007-subscribe-slug-vs-uuid.md) |
